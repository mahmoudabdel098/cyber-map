            ...
            >
                ...
                >
                    ...
                    <div className="absolute inset-0 [aspect-ratio:1] h-[100cqh] [border-radius:0] [mask:none] animate-shimmer-slide">
                        {/* spark before */}
                        <div className="absolute -inset-full w-auto [translate:0_0] rotate-0 [background:conic-gradient(from_calc(270deg-(var(--spread)*0.5)),transparent_0,var(--shimmer-color)_var(--spread),transparent_var(--spread))] animate-spin-around" />
                    </div>
                </div>
                {children}
